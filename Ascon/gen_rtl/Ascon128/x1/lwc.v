...
module lwc(clk,
  ...
  wire [7 : 0] IF_ascon_bdiFlags_56_BIT_4_12_THEN_IF_ascon_in_ETC___d217,
	       ...
	       b__h51639,
	       spliced_bits__h3337;
  wire [3 : 0] a__h45832, oh__h45771, valid_bytes__h45043;
  wire [1 : 0] x__h9292;
  ...
  assign MUX_lwc_doSender_data_reg_write_1__VAL_2 = { 1'd0, sw__h49058 } ;
  ...
  assign ascon_inLayer_counter_D_IN =
	     ascon_inLayer_enq_wire_whas ? x__h9292 : 2'd0 ;
  ...
  always@(MUX_lwc_outCounter_write_1__SEL_1 or
	  ...
	  WILL_FIRE_RL_lwc_verify_tag or x__h52798)
  begin
    case (1'b1) // synopsys parallel_case
      MUX_lwc_outCounter_write_1__SEL_1:
      ...
      WILL_FIRE_RL_lwc_verify_tag: lwc_outCounter_D_IN = x__h52798;
  ...
  assign NOT_IF_lwc_tagFifo_rv_port0__read__70_BIT_32_7_ETC___d606 =
	     lwc_tagFifo_rv[31:0] != sw__h49058 ;
  ...
  assign _dand2ascon_inLayer_do_close_EN_wset =
	     ...
	     (lwc_pdiCounter[13:1] == 13'd0 && !lwc_inFlags[8] &&
	      ...
	      !lwc_inFlags[8] &&
	      lwc_inSegEoT) ;
  assign a__h45832 = oh__h45771 - 4'd1 ;
  ...
  assign x__h46454 =
		 ...
		 (valid_bytes__h45043[2] ? 8'h80 : 8'd0),
	       valid_bytes__h45043[2] ?
		 lwc_pdiReceiver_fifof_rv_BITS_31_TO_0__q1[15:8] :
		 (valid_bytes__h45043[1] ? 8'h80 : 8'd0),
	       valid_bytes__h45043[1] ?
		 lwc_pdiReceiver_fifof_rv_BITS_31_TO_0__q1[23:16] :
		 (valid_bytes__h45043[0] ? 8'h80 : 8'd0),
	       valid_bytes__h45043[0] ?
		 lwc_pdiReceiver_fifof_rv_BITS_31_TO_0__q1[31:24] :
		 8'h80 } ;
  assign x__h52798 = lwc_outCounter - 14'd1 ;
